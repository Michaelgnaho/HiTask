...
function Footer() {
	return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-blue-900 text-white animate">
            <div className="flex flex-col items-start w-full max-w-4xl px-4 animate">
                <h1 className="text-2xl font-bold mb-2 animate">HiTask</h1>
                <p className="mb-8 animate">Your all-in-one management platform.</p>
                <div className="flex flex-col items-start mb-8 animate">
                ...
                <div className="flex flex-wrap justify-between w-full ">
                    ...
                    <div className="flex flex-col mb-4 animate">
